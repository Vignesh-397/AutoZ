...
if(isset($_POST['owner_name'])){
    ...
    $sql = "INSERT INTO `sold_bikes` (`owner_name`,  `phone`, `brand`, `model`, `year`, `bike_num`,`price`, `img_url`, `review_date`) 
    VALUES ('$owner_name',  '$phone', '$brand', '$model', '$year', '$bike_num', '$price', '$img_url', '$review_date')";
            ...
            <ol>
                ...
                <li class="menu-item" aria-haspopup="true">
                    ...
                    <ol class="sub-menu" aria-label="submenu">
                        ...
                        <li class="menu-item"><a href="#">Sell Bikes</a></li>
                    </ol>
                </li>
    ...
    <div class="container ">
        ...
        <form action="sellbikes.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="input-data">
                    <input type="text" name="bike_num" id="bike_num" required>
                    <div class="underline"></div>
                    <label for="">Bike Number</label>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="input-data " id="img">
                    Please Select Your Bike Review Date
